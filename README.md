...
| `proxy`       | Configures a proxy (AWS API Gateway IP rotation, SOCKS/HTTP, or Oxylabs) via `proxy aws`/`proxy oxylabs`/`proxy socks`/`proxy http`. | [Read Docs](https://js-recon.io/docs/docs/modules/proxy)       |
